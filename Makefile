...
mpi_heat2D:  mpi_heat2D.c draw_heat.c
	$(CC) $(FLAGS) mpi_heat2D.c draw_heat.c -o mpi_heat2 -lX11
...
mpi_pi_reduce:  mpi_pi_reduce.c dboard.c
	$(CC) $(FLAGS) mpi_pi_reduce.c dboard.c -o mpi_pi_reduce

mpi_pi_send:  mpi_pi_send.c dboard.c
	$(CC) $(FLAGS) mpi_pi_send.c dboard.c -o mpi_pi_send
